run_app:
	python3 randomiser.py & sleep 30
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|UniteRandomiser\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|UniteRandomiser/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|UniteRandomiser/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|UniteRandomiser/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|UniteRandomiser/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|UniteRandomiser/assets|g' {} \;
